...
In order to run this project, an environment must be set up matching the VTMIT ECE 5984 Amazon environment. This includes an Amazon EC2 instance and an Amazon S3 bucket.
