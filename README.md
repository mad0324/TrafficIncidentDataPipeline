...
In order to run this project, an environment must be set up matching the VTMIT ECE 5984 Amazon environment. To do so, create an AWS pipeline with ingestion, an Amazon EC2 instance, and an Amazon S3 bucket.
